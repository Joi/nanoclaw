# GIDC Assistant DM (Template)

This is a GIDC (Gross Increase in Dragon Count) workspace assistant direct message. Replace this directory name with the actual Slack user ID once the app is installed (e.g., `slack-gidc-UXXXXXX`).

## Channel Mode

`available` — Respond to direct messages from GIDC workspace members. Mode can be toggled with commands below.
...
If you need these features, contact the workspace owner (Joi or Kesang).
